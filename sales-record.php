            ...
            <tr>
              <td width="1090" height="184"><div class="card">
                ...
                <div class="card-footer">
                  <a class="btn btn-primary" href="add-sales.php">Add Sales</a>
              ...
              <th><div align="center"><span class="style1">Sales ID</span></div></th>
              <th><div align="center"><span class="style1">Customer Name</span></div></th>
              <th><div align="center"><span class="style1">Drug </span></div></th>
              <th><div align="center"><span class="style1">Sales Date </span></div></th>
              ...
              <th><div align="center"><span class="style1">Unit Price</span></div></th>
                    ...
                    ?>
                      ...
                      <td><div align="center" class="style2"><?php echo $cnt;  ?></div></td>
                       <td><div align="center" class="style2"><span class="controls"><img src="<?php echo $row['photo'];?>"  width="50" height="43" border="2"/></span></div></td>
                        <td><div align="center" class="style2"><?php echo $row['saleID'];  ?></div></td>
                        <td><div align="center" class="style2"><?php echo $row['customerName'];  ?></div></td>
						            <td><div align="center" class="style2"><?php echo $row['drugName'];  ?> </div></td>
                        <td><div align="center" class="style2"><?php echo $row['saleDate'];  ?></div></td>
                        ...
                        <td>
                           <div align="center">
                           <a href="delete-sales.php?sid=<?php echo $row['saleID'];?>&qty_new=<?php echo $row['quantity'];?>&qty_old=<?php echo $row['qty'];?>&pid=<?php echo $row['productID'];?>" onClick="return deldata('<?php echo $row['drugName']; ?>');">Delete </a></div>
                            </td>
                    </tr>
                    <?php $cnt=$cnt+1;} ?>
                    </tbody>
