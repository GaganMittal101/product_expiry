...
if(empty($_POST['txtconfirm_password']) && empty($_POST['txtprice'])  ){
  ...
  $sql = 'INSERT INTO tblstock(productID,stockDate,drugName,unitPrice,quantity) VALUES(:productID,:stockDate,:drugName,:unitPrice,:quantity)';
  ...
  if ($statement){
   ...
   // header( "refresh:2;url= add-purchase.php" );
    ...
    $_SESSION['error'] ='Problem Adding Stock';
  }
  }
          ...
          <div class="card-body">
            <div class="row">
             ...
             echo '</select>';
                ...
                <!-- /.form-group -->
                <div class="form-group">
                    <label for="exampleInputEmail1">Stock-in Date</label>
                    <input type="text" class="form-control" name="txtstockinDate" id="txtstockinDate" size="77" value="<?php echo $current_date; ?>"  >
                  </div>
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="txtqty" id="txtqty" size="77" value="0" >
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtprice" id="txtprice" size="77" value="<?php if (isset($_POST['txtprice']))?><?php echo $_POST['txtprice']; ?>" onKeyUp="calculation(this.value)">
                  </div>
